...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { address: @office.address, company_id: @office.company_id, name: @office.name, registration_number: @office.registration_number, status: @office.status, telephone: @office.telephone } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { address: @office.address, company_id: @office.company_id, name: @office.name, registration_number: @office.registration_number, status: @office.status, telephone: @office.telephone } }
